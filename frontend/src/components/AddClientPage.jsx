  ...
  return (
    <div className="p-4 sm:p-6 w-full sm:max-w-md mx-auto">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
        <div className="mb-4">
          <label className="block text-gray-700 mb-2 text-sm sm:text-base">Client Name</label>
          <input
            type="text"
            value={clientName}
        ...
        <div className="mb-4">
          <label className="block text-gray-700 mb-2 text-sm sm:text-base">Type</label>
          <input
            type="text"
            value={type}
        ...
        <div className="mb-4 sm:mb-6">
          <label className="block text-gray-700 mb-2 text-sm sm:text-base">Amount To Be Paid</label>
          <input
            type="number"
