...
const SignInPage = ({ setSessionToken, setCurrentUser, setPage }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full sm:max-w-md mx-auto mt-16 sm:mt-20 p-4 sm:p-6 bg-white rounded-lg shadow-lg">
        ...
        {isSignup ? (
          <div>
            ...
            <p className="text-center mt-2 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-1 text-sm sm:text-base">
